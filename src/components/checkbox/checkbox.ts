      ...
      return html`
        ...
        >
          ...
          <label 
            ...
            ${ 
              checkbox.isRequired ?  
              html`<span class="pf-v5-c-check__label-required" aria-hidden="true" part = "icon" >&#42;</span>` :
              html ``
            }
          </label>

          ${
            !checkbox.isNoDescription ?
            html`<span class="pf-v5-c-check__description" part = "description">
          ...
          ${
            !checkbox.isNoBody ?
            html`<span class="pf-v5-c-check__body" part = "body">
              <slot name = "body"></slot>
            </span>` : 
            html``
          }
